...
export const jadeAbyss: ThemeDefinition = {
  ...
  colors: {
    ...
    graphEdgeCausedBy: '#D75F5F',
    graphEdgeLeadsTo: '#D9A24E',
    graphEdgeResolvedBy: '#45C882',
    graphEdgeSimilarTo: '#5A9CF5',
    graphEdgeContradicts: '#E5A84B',
    graphEdgeDependsOn: '#9A86F0',
    graphEdgeExtends: '#4DCAC2',
    graphEdgeReferences: '#6E7688',
    graphProject1: '#D98263',
    graphProject2: '#D2AA58',
    graphProject3: '#63B881',
    graphProject4: '#55B2A8',
    graphProject5: '#679CE8',
    graphProject6: '#8B80D9',
    graphProject7: '#B483C4',
    graphProject8: '#8B95A6',
    graphProject9: '#69899D',
    graphProject10: '#C66F77',
  },
  fonts: {
