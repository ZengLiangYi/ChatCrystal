...
// Total: 210 frames (7s). Transitions: 2 × 10 = 20. Segments sum = 230.
// Status: content done ~32, hold ~38 frames → 70.
// Tags: content done ~38, hold ~32 frames → 70.
// Summarize: content done ~55, hold ~35 frames → 90.
